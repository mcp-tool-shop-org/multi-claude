...
OUTPUT DIRECTORY: F:/AI/multi-claude/.multi-claude/drill/attempt-2
...
1. F:/AI/multi-claude/.multi-claude/drill/attempt-2/artifacts.json — what files you changed:
{
  "files_created": [
    "path/to/new-file.ts"
  ],
...
2. F:/AI/multi-claude/.multi-claude/drill/attempt-2/writeback.json — structured knowledge writeback (MUST match this exact shape):
{
  "writeback": {
...
IMPORTANT: F:/AI/multi-claude/.multi-claude/drill/attempt-2/writeback.json MUST have a top-level "writeback" key containing all fields.
...
IF YOU ENCOUNTER AN F:/AI/multi-claude/.multi-claude/drill/attempt-2/ERROR:
- Write the error description to F:/AI/multi-claude/.multi-claude/drill/attempt-2/ERROR
- Do NOT write F:/AI/multi-claude/.multi-claude/drill/attempt-2/artifacts.json or F:/AI/multi-claude/.multi-claude/drill/attempt-2/writeback.json if there was an unrecoverable error